// Auto-generated by scripts/generate-pokemon-names.js
// Do not edit manually.

export const POKEMON_NAMES_ES: Record<string, string> = {
  'bulbasaur': 'Bulbasaur',
  'ivysaur': 'Ivysaur',
  'venusaur': 'Venusaur',
...
export function resolveEnglishName(input: string): string {
  const key = input.toLowerCase().trim();
  return _REVERSE[key] ?? key;
}
